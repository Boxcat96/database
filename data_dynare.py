...
# %%  GDP vs Investment
fig = plt.figure()
plt.plot(df_dynare["b_obs"],label="Government debt",color ="deepskyblue")
plt.plot(df_dynare["g_obs"],label="Government investment",color ="darkorange")
plt.axhline(y=0,color ="black", lw=0.5)
plt.legend(loc = 'upper left')
plt.show()
fig.savefig('graph\BvsG.png', dpi = 1000)
# %%  GDP vs Investment
fig = plt.figure()
plt.plot(df_dynare["pi_obs"],label="Inflation rate",color ="deepskyblue")
plt.plot(df_dynare["epi_obs"],label="Exp. Inflation rate",color ="darkorange")
plt.axhline(y=0,color ="black", lw=0.5)
plt.legend(loc = 'upper right')
plt.show()
fig.savefig('graph\PIvsEPI.png', dpi = 1000)
# %%  GDP vs Consumtion
fig = plt.figure()
plt.plot(df_dynare["pi_obs"],label="Inflation rate",color ="deepskyblue")
...
plt.legend(loc = 'upper right')
plt.show()
fig.savefig('graph\PIvsR.png', dpi = 1000)
# %% Taylor rule
fig = plt.figure()
