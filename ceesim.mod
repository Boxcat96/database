...
h, normal_pdf, 0.7, 0.1; %消費者の習慣形成の度合い
omega, beta_pdf, 0.3, 0.1; %非リカード家計の割合
nu, normal_pdf, 0.25, 0.1; %社会資本の生産力効果
zw, beta_pdf, 0.375, 0.1; %賃金を最適化できない確率
phi, beta_pdf, 0.8, 0.1; %金融政策ショックの持続性
phipi, normal_pdf, 1.5, 0.1; %テイラールールのインフレ率の項
...
phiyt, normal_pdf, 0.1, 0.1; %課税ルールのGDPの項
rhog, beta_pdf, 0.6, 0.2; %公共消費ショックの持続性
rhoz, beta_pdf, 0.85, 0.1; %技術ショックの持続性
...
//推計コマンド(カルマンスムージングなし)//////////////////////////////
estimation(datafile=DB_dynare, mode_check, mh_replic=10000, mh_nblocks=2, 
